...
//    $student_email = $_SESSION['student_email'];
    ...
    reg_number = '$registration_number', leave_absence = '$loa', project_title = '$project_title', 
...
//        die();
        header("location:http://".$_SERVER['SERVER_NAME']."/pg_project/supervisor.php?email=$student_email&hash=$hash");
    }
}
